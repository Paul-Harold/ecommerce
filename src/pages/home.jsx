...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchAllData() {
      try {
        // 1. Fetch CMS Text & Layout Settings
        ...
        // 2. Fetch the specific Featured Products chosen in Admin Dashboard
  ...
  return (
    <div className="min-h-screen bg-midnight text-white">
      ...
      {/* ... (Kept exactly identical to your beautiful grid layout!) ... */}
      <div className="relative z-20 bg-midnight w-full py-24 px-6 border-t border-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-widest">Upgrade Your <span className="text-electric">Arsenal</span></h2>
      ...
      <div className="bg-gradient-to-b from-black to-midnight w-full py-24 px-6 border-t border-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <input type="email" placeholder="Enter your email address" className="bg-gray-900 border border-gray-700 text-white px-6 py-4 rounded focus:outline-none focus:border-electric focus:ring-1 focus:ring-electric transition-all flex-grow max-w-md placeholder-gray-500" />
            <button className="bg-electric text-midnight font-bold py-4 px-8 rounded hover:bg-white hover:shadow-[0_0_20px_#40E0FF] transition-all duration-300 uppercase tracking-wider">Subscribe</button>
          </div>
        </div>
      </div>

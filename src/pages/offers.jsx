...
export default function Offers() {
  ...
  return (
    <div className="min-h-screen bg-midnight text-white flex flex-col">
      <div className="flex-grow pt-10 pb-24 px-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          {activePromo && (
            <div className="mb-16 bg-ion/10 border border-ion/30 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between shadow-[0_0_30px_rgba(57,255,20,0.15)]">
              <div>
                <div className="inline-block px-4 py-1 bg-ion text-midnight rounded-full text-xs font-bold uppercase tracking-widest mb-4 animate-pulse">
                  Active Link Detected
                </div>
                <h2 className="text-3xl font-black uppercase tracking-widest text-white mb-2">{activePromo.title}</h2>
                <p className="text-gray-400">You have successfully unlocked a {activePromo.discount_percent}% discount on eligible gear.</p>
              </div>
              <button onClick={() => navigate('/shop')} className="mt-6 md:mt-0 bg-ion text-midnight font-bold py-4 px-10 rounded hover:bg-white transition-all duration-300 uppercase tracking-wider whitespace-nowrap">
                Shop Eligible Gear
              </button>
            </div>
          )}
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8 text-center max-w-4xl mx-auto">
            <p className="text-xs text-gray-500 uppercase tracking-widest font-mono leading-relaxed">
      ...
      <footer className="bg-[#050608] w-full pt-16 pb-8 px-6 border-t border-gray-900 text-sm mt-auto">

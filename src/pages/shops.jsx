        ...
        <div className="max-w-[1400px] mx-auto">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4 items-center">
              ...
              {searchQuery && (
                <button
                  ...
                  className="px-6 py-2 rounded-full text-sm font-bold uppercase tracking-wider transition-all duration-300 border bg-red-500/10 text-red-500 border-red-500/30 hover:bg-red-500 hover:text-white ml-2 flex items-center gap-2"
                >
                  Clear Search: "{searchQuery}" <span className="text-lg leading-none">×</span>
                </button>
              )}
            </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-24 border border-dashed border-gray-800 rounded-xl">
              <p className="text-gray-500 text-xl font-bold uppercase tracking-widest mb-2">No gear found matching that query.</p>
              <p className="text-gray-600 text-sm">Try searching for something else, like "Mouse" or "Keyboard".</p>
            </div>
          )}
